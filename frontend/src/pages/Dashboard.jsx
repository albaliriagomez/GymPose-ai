      ...
      <div className="max-w-6xl mx-auto space-y-5 pb-8">
        ...
        <div className="flex items-center justify-between animate-fadeInUp">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`w-4 h-4 ${spinning ? 'animate-spin' : ''}`}>
        ...
        <div className="rounded-2xl border border-gym-border bg-gym-sidebar p-4 flex items-center justify-between gap-4">
          <div>
            ...
            <h2 className="mt-1 font-display text-xl font-bold text-white">
              Rutina, objetivo y plan
            </h2>
            <p className="mt-1 text-sm text-gym-muted">
              Revisa tu plan semanal sin salir del panel.
            </p>
          </div>
          <button
